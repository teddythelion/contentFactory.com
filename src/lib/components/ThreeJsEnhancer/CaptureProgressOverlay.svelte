...
{#if isVisible}
  <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm">
    <div class="mx-4 w-full max-w-md rounded-lg border border-white/10 bg-gray-900 p-8 shadow-2xl">

      {#if encodingStarted}
        <!-- ENCODING STARTED STATE — "You're free to go" -->
        ...
        <p class="mb-6 text-center text-base text-gray-300 leading-relaxed">
          This takes <span class="text-white font-semibold">1–2 minutes</span>. You're free to navigate away — your video will <span class="text-green-400 font-semibold">automatically download</span> and be <span class="text-blue-400 font-semibold">saved to your library</span> when it's ready.
        </p>

        <div class="mb-6 rounded-lg border border-green-500/30 bg-green-900/20 p-4">
          <p class="text-center text-sm text-green-300">
            ✅ All frames captured & uploaded successfully
          </p>
        </div>
      ...
      {:else}
        ...
        <div class="mt-6 rounded border border-yellow-500/30 bg-yellow-900/20 p-3">
